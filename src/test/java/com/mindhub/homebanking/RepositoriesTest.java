...
public class RepositoriesTest {
    ...
    @Test
    public void validarAtributosAccount(){
        List<Account> accounts = accountRepository.findAll();
    ...
    @Test
    public void validarAtributosCard(){
        List<Card> cards = cardRepository.findAll();
        assertThat(cards, hasItem(hasProperty("id", is(not(empty())))));
        assertThat(cards, hasItem(hasProperty("cardholder", is(not(empty())))));
        assertThat(cards, hasItem(hasProperty("clientCard", is(not(empty())))));
        assertThat(cards, hasItem(hasProperty("type", is(not(empty())))));
        assertThat(cards, hasItem(hasProperty("color", is(not(empty())))));
    ...
    @Test
    public void validarAtributosClient(){
        List<Client> clients = clientRepository.findAll();
